...
- YM output: `Resampled` (default) or `Direct` fallback
...
Song/bank/speed/drums/CPU clock/YM clock/YM output/mix/channel settings apply immediately (next audio quantum).
